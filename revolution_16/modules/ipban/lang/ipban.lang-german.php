...
function ipban_translate($phrase) {
   switch ($phrase) {
      ...
      case "Chaque ligne ne doit contenir qu'une adresse IP (v4 ou v6) de forme : a.b.c.d|X (ex. v4 : 168.192.1.1|5) ; 2001:0db8:0000:85a3:0000:0000:ac1f:8001|X (ex. v6 : 2001:0db8:0000:85a3:0000:0000:ac1f:8001|5).": $tmp = "Jede Zeile sollte Dass eine IP-Adresse (v4 oder v6) der Form : a.b.c.d|X (zb v4 : 168.192.1.1|5) ; 2001:0db8:0000:85a3:0000:0000:ac1f:8001|X (zb v6 : 2001:0db8:0000:85a3:0000:0000:ac1f:8001|5)."; break;
