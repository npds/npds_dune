...
function marquetapage() {
   ...
   <a href="modules.php?ModPath=marquetapage&amp;ModStart=marquetapage&amp;op=supp_all&amp;uri='.$_SERVER['PHP_SELF'].'"><i class="far fa-trash-alt text-danger fa-lg" title="'.translate("Delete").'" data-toggle="tooltip"></i></a>';
         while(list($uri, $topic)=sql_fetch_row($result)) {
            $content.='
            <div class="row">
               <div class="col-10 n-ellipses"><a href="'.$uri.'" class="small ">'.$topic.'</a></div>
               <div class="col-2 text-right"><a href="modules.php?ModPath=marquetapage&amp;ModStart=marquetapage&amp;op=supp&amp;uri='.urlencode($uri).'"><i class="far fa-trash-alt text-danger" title="'.translate("Delete").'" data-toggle="tooltip"></i></a></div>
            </div>';
         }
         $content.='
   </div>';
