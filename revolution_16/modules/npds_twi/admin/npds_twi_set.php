...
function Configuretwi($subop, $ModPath, $ModStart, $class_sty_2, $npds_twi_arti, $npds_twi_urshort, $npds_twi_post, $consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret, $tbox_width, $tbox_height) {
   ...
   <form action="admin.php" method="post">
            <div class="form-group row">
               <label class="form-control-label col-xs-12" for="title">   
    ...
    -->
     ...
     &nbsp;<input type="radio" name="npds_twi_urshort" value="3" '.$urshort_c.' />&nbsp;'.twi_trad('R&#xE9;&#xE9;criture d\'url avec contr&#xF4;leur Npds').'
      ...
      <div class="form-group row">
         <label class="form-control-label col-sm-12" for="consumer_key">'.twi_trad('Votre clef de consommateur').'&nbsp;<span class="rouge">*</span></label>
         <div class="col-sm-12">
      ...
      <div class="form-group row">
         <label class="form-control-label col-sm-12" for="consumer_secret">'.twi_trad('Jeton d\'acc&#xE8;s pour Open Authentification (oauth_token)').'&nbsp;<span class="text-danger">*</span></label>
         <div class="col-sm-12">
     ...
     <td width="30%">
     '.twi_trad('Jeton d\'acc&#xE8;s secret pour Open Authentification (oauth_token_secret)').' <span class="text-danger">*</span> : '.$oauth_token_secret.'
     </td>
     <td>
