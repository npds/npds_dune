   ...
   echo '
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-8">
               ...
               <span class="help-block">Répertoire/fichier de stockage de la log de téléchargement (par défaut /slogs/security.log)<span class="float-right ml-1" id="countcar_xrep_log"></span></span>
            </div>
         </div>
         <div class="form-group row">
