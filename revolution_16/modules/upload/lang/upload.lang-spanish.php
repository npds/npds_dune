...
function upload_translate($phrase) {
 switch($phrase) {
   ...
   case "Adapter": $tmp="Actualización"; break;
   ...
   case "Raffraichir la page": $tmp="Actualizar la página"; break;
   ...
   case "Erreur de téléchargement du fichier <b>%s</b> (%s) - Le fichier n'a pas été sauvé": $tmp="Error al subir fichero <b>%s</b> (%s) - El fichero no guardado"; break;
   case "<center><b>Fichier {NAME} bien recu ({SIZE} octets transférés)</b></center>": $tmp="<center><b>Fichero {NAME} subida ({SIZE} bytes transferidos)</b></center>"; break;
   case "Erreur de téléchargement du fichier - fichier non sauvegardé.": $tmp="Error al subir fichero - El fichero no guardado"; break;

   // NPDS Sable
   case "Images & Documents": $tmp="Imágenes y Documentos"; break;
