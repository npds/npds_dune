...
/************************************************************************/
global $NPDS_Prefix;
// quand un form est utilisé plusieurs fois dans des context différents add/mod/new les variables ne sont pas toujours définies ce qui entraine des notices php dans les if ...solution peu élégante mais efficace
...
// LNL
$checked = $chng_user_viewemail ? true : false ;
...
$requi = $op == 'ModifyUser' ? false : true ;
