...
$m->add_extender('add_uname', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_uname"></span></span>');

$m->add_field('add_name', adm_translate("Nom"),$chng_name,'text',false,60,'','');
$m->add_extender('add_name', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_name"></span></span>');

$m->add_field('add_email', adm_translate("E-mail"),$chng_email,'email',false,60,'','');
$m->add_extender('add_email', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_email"></span></span>');

$m->add_field('add_femail',adm_translate("Adresse E-mail masquée"),$chng_femail,'email',false,60,'','');
$m->add_extender('add_femail', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_femail"></span></span>');
...
$m->add_extender('add_url', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_url"></span></span>');
...
$m->add_extender('add_user_from', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_user_from"></span></span>');

$m->add_field('add_user_occ', adm_translate("Activité"),$chng_user_occ,'text',false,100,'','');
$m->add_extender('add_user_occ', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_user_occ"></span></span>');

$m->add_field('add_user_intrest', adm_translate("Centres d'intérêt"),$chng_user_intrest,'text',false,150,'','');
$m->add_extender('add_user_intrest', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_user_intrest"></span></span>');
...
$m->add_extender('add_user_sig', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_user_sig"></span></span>');

$m->add_field('add_bio',adm_translate("Informations supplémentaires"),$chng_bio,'textarea',false,255,7,'','');
$m->add_extender('add_bio', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_bio"></span></span>');

$m->add_field('add_pass', adm_translate("Mot de Passe"),'','password',false,40,'','');
$m->add_extender('add_pass', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_pass"></span></span>');
...
if ($op=="ModifyUser") {
   ...
   $m->add_extender('add_pass2', '', '<span class="help-block"><span class="float-xs-right" id="countcar_add_pass2"></span></span>');
}
// --- EXTENDER
