...
$m->add_title("Fiche Complémentaire");
...
$m->add_field('dpt', "Département","",'text',false,25,"","");
...
$m->add_select('f4', "Compétences techniques",$tmp,false,5,true);
...
$m->add_checkbox('f7', "Centre de Formation Agréé", '100', false, true);
