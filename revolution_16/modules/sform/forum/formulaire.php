...
$m->add_title("NPDS Forum Extender :: Problèmes ");
...
$m->add_select('t1', "Votre Système d'Exploitation",$tmp,false,4,false);
...
$m->add_select('t5', "Type de problème",$tmp,false,6,false);
...
$m->add_select('t6', "Votre hébergeur",$tmp,false,5,false);
