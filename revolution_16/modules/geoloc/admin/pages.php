...
$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=geoloc*']['js']=array("http://maps.google.com/maps/api/js?v=3.exp&amp;key=".$api_key."&amp;language=fr","modules/geoloc/include/fontawesome-markers.min.js","");
...
$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=geoloc*']['css']="geoloc_style.css+";
