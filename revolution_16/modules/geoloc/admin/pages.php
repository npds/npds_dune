...
$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=geoloc*']['js']=array("http://maps.google.com/maps/api/js?v=3.exp&amp;key=".$api_key."&amp;language=fr&amp;libraries=weather,geometry","modules/geoloc/include/fontawesome-markers.min.js","");
