...
// ----------------
   ...
   //               => s'il existe un fichier de configuration portant le nom du groupe ALORS tous les membres du groupe partage le même fichier
...
// REPERTOIRES ----
// ----------------
   // Vous pouvez limiter la navigation à un sous-repertoire se trouvant sous la racine de votre site
   ...
   // admin    => ce répertoire n'est visible que par les administrateur
   //
   // => $dirlimit_fma=
   // array (
   //       'ftp' => 'anonyme',
   ...
   // $dirpres_fma permet de controler les informations affichées relatives aux repertoires (0 non affiché / 1 affiché)
   // position 1 = icone
   ...
   // $dircmd_fma permet de controler les actions autorisées relatives aux repertoires (0 non-autorisé / 1 autorisé)
   // position 1 = create
   // position 2 = rename
   // position 3 = delete
   // position 4 = chmod
...
// -------------
   ...
   // $extension_Wysiwyg_fma permet de définir la liste des extensions Editables qui supporterons un editeur Wysiwyg (TinyMce par exemple)
...
// ----------
   ...
   // $wopen_fma permet de spécifier si une seule fenetre fille est utilisée (0 : Non / 1 : Oui) lors d'une demande d'affichage
   // Attention cette option peut être incompatible avec certaines utilisation du File-Manager
   // $wopenH_fma permet de spécifier la hauteur de la fenetre fille (par défaut 500)
   // $wopenW_fma permet de spécifier la largeur de la fenetre fille (par défaut 400)
   // $wopenH_fma=500;
   // $wopenW_fma=400;
