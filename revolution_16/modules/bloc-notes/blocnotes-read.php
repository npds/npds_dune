...
//echo "document.write('<script type=\"text/javascript\">document.A$bnid.texteBlocNote.value=unescape(\'".str_replace(chr(13).chr(10),"\\\\n",str_replace("'","\\\\\'",$texte))."\');</script>')";
echo '$(function(){ $("#texteBlocNote_'.$bnid.'").val(unescape("'.$texte.'")) })';
?>