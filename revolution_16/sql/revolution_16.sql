...
INSERT INTO fonctions (fid, fnom, fdroits1, fdroits1_descr, finterface, fetat, fretour, fretour_h, fnom_affich, ficone, furlscript, fcategorie, fcategorie_nom, fordre) VALUES(44, 'mod_users', 1, '', 1, 1, '', 'Utilisateur en attente de validation !', 'Utilisateurs', 'users', 'href="admin.php?op=nonallowed_users"', 9, 'Alerte', 0);
