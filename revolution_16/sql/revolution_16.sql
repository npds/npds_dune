...
INSERT INTO fonctions (fid, fnom, fdroits1, fdroits1_descr, finterface, fetat, fretour, fretour_h, fnom_affich, ficone, furlscript, fcategorie, fcategorie_nom, fordre) VALUES(35, 'reviews', 20, '', 1, 1, '0', 'Critique en atttente de validation.', 'Critiques', 'reviews', 'href="admin.php?op=reviews#valider_critique"', 9, 'Alerte', 0);
...
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('!date!', 'function MM_date () {global $gmt;\n   return formatTimes(time(), IntlDateFormatter::FULL, IntlDateFormatter::MEDIUM, $gmt);\r\n}', 'meta', '-', NULL, '[french]Date du jour[/french]', '1');
...
INSERT INTO users VALUES (2, 'user', 'user', 'user@user.land', '', 'http://www.userland.com', '014.gif', '989445600', '', '', '', 'User of the Land', 0, 0, '', 'd.q1Wcp0KUqsk', 0, 10, '', 0, 0, 0, '', 1, '<ul><li><a href=https://www.npds.org target=_blank>NPDS.ORG</a></li></ul>', 'npds-boost_sk+default', 4096, 4, 0, 1, 1, 'french', '1384102103', 1);
