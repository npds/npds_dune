...
(2, 'Administration', '<ul><li><a href="admin.php"><i class="fas fa-sign-in-alt fa-2x align-middle"></i> Administration</a></li><li><a href="admin.php?op=logout" class=" text-danger"><i class="fas fa-sign-out-alt fa-2x align-middle"></i> [french]Déconnexion[/french][english]Logout[/english][chinese]登出[/chinese][spanish]Cerrar sesión[/spanish][german]Ausloggen[/german]</a></li></ul>');
