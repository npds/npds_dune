<?php
/************************************************************************/
/* Theme for NPDS / Net Portal Dynamic System     zero_bmag                   */
/*======================================================================*/
/* This theme use the NPDS theme-dynamic engine (Meta-Lang)             */
/*                                                                      */
/* Theme : jpb Jireck Bmag     zero_bmag            */
/*                                                                      */
...
case "3":
     echo '<aside id="leftcol" class="col w18 notablet nomobile  aside">';
        leftblocks();
     echo '</aside>';
     echo '<aside id="rightcol" class="col w18 notablet nomobile   aside">';    /* la colonne de droite qui aura les BLOCS de droites */
        rightblocks();
     echo '</aside>';
