...
switch ($op) {
   ...
   break;
   case 'edituser':
      if ($user) edituser(); else header('Location: index.php');
   break;
   case 'saveuser':
      $past = time() - 300;
   ...
   break;
   case 'edithome':
      if ($user) edithome(); else header('Location: index.php');
   break;
   case 'savehome':
   ...
   break;
   case 'chgtheme':
      if ($user) chgtheme(); else header('Location: index.php');
   break;
   case 'savetheme' : 
   ...
   break;
   case 'editjournal':
      if ($user) editjournal(); else header('Location: index.php');
   break;
   case 'savejournal':
   ...
   case 'askforgroupe':
      if ($user) {
         ...
         $file = 'users_private/groupe/ask4group_'.$userdata[0].'_'.$askedgroup.'_.txt';
         if (!file_exists($file))
            touch($file);
      }
      header('Location: index.php');
