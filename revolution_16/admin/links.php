    ...
    echo '
         <tr>
            ...
            <td>
               ...
               <a href="admin.php?op=LinksDelLink&amp;lid='.$lid.'" class="text-danger"><i class="far fa-trash fa-lg ml-3"></i></a>
            </td>
         </tr>';
   }
   echo '
    ...
    echo '
      ...
      <div class="form-group row">
         <div class="col-sm-8 ml-sm-auto">
            ...
            <a href="admin.php?op=LinksDelLink&amp;lid='.$lid.'" class="btn btn-danger"><i class="far fa-trash fa-lg"></i>&nbsp;'.adm_translate("Effacer").'</a>
         </div>
      </div>
   </form>';
   ...
   <form action="admin.php" method="post" id="linkseditorial">
      ...
      <div class="form-group row">
         <div class="col-sm-8 ml-sm-auto">
            ...
            <button href="admin.php?op=LinksDelEditorial&amp;linkid='.$lid.'" class="btn btn-danger"><i class="far fa-trash fa-lg"></i>&nbsp;'.adm_translate("Effacer").'</button>
         </div>
      </div>';
      }
    }
...
function LinksListBrokenLinks() {
   ...
   <div class="blockquote">
      <i class="far fa-trash fa-lg text-primary mr-2"></i>'.adm_translate("Ignorer (Efface toutes les demandes pour un Lien donné)").'<br />
      <i class="far fa-trash fa-lg text-danger mr-2"></i>'.adm_translate("Effacer (Efface les Liens cassés et les avis pour un Lien donné)").'
   </div>';
   ...
   <table id="tad_linkbrok" data-toggle="table" data-striped="true" data-search="true" data-show-toggle="true" data-mobile-responsive="true" data-buttons-class="outline-secondary" data-icons="icons" data-icons-prefix="fa">
      ...
      while (list($requestid, $lid, $modifysubmitter)=sql_fetch_row($resultBrok)) {
         ...
         echo '
            ...
            <td><a href="admin.php?op=LinksIgnoreBrokenLinks&amp;lid='.$lid.'" ><i class="far fa-trash fa-lg" title="'.adm_translate("Ignorer (Efface toutes les demandes pour un Lien donné)").'" data-toggle="tooltip" data-placement="left"></i></a></td>
            <td><a href=admin.php?op=LinksDelBrokenLinks&amp;lid='.$lid.'" ><i class="far fa-trash text-danger fa-lg" title="'.adm_translate("Effacer (Efface les Liens cassés et les avis pour un Lien donné)").'" data-toggle="tooltip" data-placement="left"></i></a></td>
         </tr>';
      }
   }
   echo '
   ...
   <form action="admin.php" method="get" id="linksmodcat">
      ...
      <div class="form-group row">
         <div class="col-sm-8 ml-sm-auto">
            ...
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-lg"></i>&nbsp;'.adm_translate("Modifier").'</button>
            <a href="admin.php?op=LinksDelCat&amp;sub=0&amp;cid='.$cat[0].'" class="btn btn-danger"><i class="far fa-trash fa-lg"></i>&nbsp;'.adm_translate("Effacer").'</a>
         </div>
      </div>
   </form>';
   } else {
   ...
   <form action="admin.php" method="get" id="linksmodcat">
      ...
      <div class="form-group row">
         <div class="col-sm-8 offset-sm-4">
            ...
            <input type="hidden" name="op" value="LinksModCatS">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-lg"></i>&nbsp;'.adm_translate("Modifier").'</button>
            <a href="admin.php?op=LinksDelCat&amp;sub=1&amp;cid='.$cat[0].'&amp;sid='.$cat[1].'" class="btn btn-danger"><i class="far fa-trash fa-lg"></i>&nbsp;'.adm_translate("Effacer").'</a>
         </div>
      </div>
   </form>';
   }
