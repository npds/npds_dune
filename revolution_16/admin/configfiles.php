      ...
      <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=header_before"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=body_onload"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=header_after"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=footer_before"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a></td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=footer_after"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=new_user"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <a href="admin.php?op=delete_configfile&amp;file=user"><i class="far fa-trash fa-lg text-danger ml-3" title="'.adm_translate("Supprimer").'" data-toggle="tooltip" ></i></a>
            </td>
        </tr>
        <tr>
