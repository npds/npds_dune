         ...
         if ( $num_rows_per_order > 0 ) {
            ...
            while($temp_user = sql_fetch_assoc($result) ) {
               ...
               if ($temp_user['uid']!= 1 and $temp_user['uid']!='')
                  $useroutils .= '<a class="list-group-item text-primary" href="user.php?op=userinfo&amp;uname='.$temp_user['uname'].'" target="_blank" title="'.translate("Profile").'" ><i class="fa fa-user fa-2x align-middle"></i><span class="ml-3 d-none d-sm-inline">'.translate("Profile").'</span></a>';
               if ($temp_user['uid']!= 1 and $temp_user['uid']!='')
                  $useroutils .= '<a class="list-group-item text-primary" href="powerpack.php?op=instant_message&amp;to_userid='.urlencode($temp_user['uname']).'" title="'.translate("Send internal Message").'" ><i class="fa fa-envelope-o fa-2x align-middle"></i><span class="ml-3 d-none d-sm-inline">'.translate("Message").'</span></a>';
               if ($temp_user['femail']!='')
               ...
               if ($temp_user['url']!='')
                  $useroutils .= '<a class="list-group-item text-primary" href="'.$temp_user['url'].'" target="_blank" title="'.translate("Visit this Website").'"><i class="fa fa-external-link fa-2x align-middle"></i><span class="ml-3 d-none d-sm-inline">'.translate("Visit this Website").'</span></a>';
               if ($temp_user['mns'])
                   $useroutils .= '<a class="list-group-item text-primary" href="minisite.php?op='.$temp_user['uname'].'" target="_blank" target="_blank" title="'.translate("Visit the Mini Web Site !").'" ><i class="fa fa-desktop fa-2x align-middle"></i><span class="ml-3 d-none d-sm-inline">'.translate("Visit the Mini Web Site !").'</span></a>';
               if ($user and $temp_user['uid']!= 1)
                  $useroutils .= '<a class="list-group-item text-primary" href="memberslist.php?letter='.$letter.'&amp;sortby='.$sortby.'&amp;list='.$list.urlencode($temp_user['uname']).',&amp;page='.$page.'&amp;gr_from_ws='.$gr_from_ws.'" title="'.translate("Add to mailing list").'" ><i class="fa fa-plus-circle fa-2x align-middle">&nbsp;</i><span class="ml-3 d-none d-sm-inline">'.translate("Mailing list").'</span></a>';
               if ($user and $temp_user['uid']!= 1) {
               ...
               echo '<a tabindex="0" data-toggle="popover" data-trigger="click" data-html="true" data-title="<h4>'.$temp_user['uname'].'</h4>" data-content=\'<div class="list-group">'.$useroutils.'</div><hr />'.$my_rsos[$a].'\'></i><img data-html="true" title="" data-toggle="tooltip" class=" btn-outline-'.$clconnect.' img-thumbnail img-fluid n-ava-small" src="'.$ibid_avatar.'" alt="'.$temp_user['uname'].'" /></a>
                  </td>
