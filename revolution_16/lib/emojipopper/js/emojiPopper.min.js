...
9),h=['<div class="accordion" id="emojiPopper'+e+'" data-type="emojiPopper">'],f="true",d="show";a.each(b,function(a,c){c.groupName!=g&&(g=c.groupName,h.push('<div class="card"><div class="card-header p-0" id="group'+a+'">'),h.push('<button type="button" class="btn btn-link btn-block" data-bs-toggle="collapse" data-bs-target="#collapse'+a+'" aria-expanded="'+f+'" aria-controls="collapse'+a+'">'),h.push(c.groupName),h.push("</button></div>"),h.push('<div id="collapse'+a+'" class="collapse '+d+'" aria-labelledby="group'+
