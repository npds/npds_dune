...
$sql = 'DROP TABLE IF EXISTS adminblock;';
$result = @sql_query($sql);
...
$sql = 'DROP TABLE IF EXISTS mainblock;';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO access VALUES (1, \'User\');';
$result = @sql_query($sql);
$sql='INSERT INTO access VALUES (2, \'Moderator\');';
$result = @sql_query($sql);
$sql='INSERT INTO access VALUES (3, \'Super Moderator\');';
$result = @sql_query($sql);
$sql='CREATE TABLE adminblock (
  title varchar(250) default NULL,
  content text
) ENGINE=MyISAM ;';
$result = @sql_query($sql);
$sql='INSERT INTO adminblock VALUES (\'Administration\', \'<ul><li><a href=\"admin.php\">Administration</a></li><li><a href=\"admin.php?op=logout\">Logout</a></li></ul><ul><li><a href=\"abla.php\">Admin BlackBoard</a></li></ul>\');';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO authors VALUES(\'Root\', \'Root\', \'\', \'redaction@infocapagde.com\', \'Xu2eM5iwRoIRI\', 29, 0, 1);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'total\', \'hits\', 122);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'WebTV\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Lynx\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'MSIE\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Opera\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Konqueror\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Netscape\', 121);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Chrome\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Safari\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Bot\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Other\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'Windows\', 122);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'Linux\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'Mac\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'FreeBSD\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'SunOS\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'IRIX\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'BeOS\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'OS/2\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'AIX\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'os\', \'Other\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Chrome\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO counter VALUES (\'browser\', \'Safari\', 0);';
...
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(1, \'edito\', 1, \'\', 1, 1, \'\', \'\', \'Edito\', \'edito\', \'href=\"admin.php?op=Edito\"\', 1, \'Contenu\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(2, \'adminStory\', 1, \'\', 1, 1, \'\', \'\', \'Nouvel Article\', \'postnew\', \'href=\"admin.php?op=adminStory\"\', 1, \'Contenu\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(3, \'sections\', 1, \'\', 1, 1, \'\', \'\', \'Rubriques\', \'sections\', \'href=\"admin.php?op=sections\"\', 1, \'Contenu\', 2);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(4, \'topicsmanager\', 1, \'\', 1, 1, \'\', \'\', \'Gestion des Sujets\', \'topicsman\', \'href=\"admin.php?op=topicsmanager\"\', 1, \'Contenu\', 3);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(5, \'links\', 1, \'\', 1, 1, \'\', \'\', \'Liens Web\', \'links\', \'href=\"admin.php?op=links\"\', 1, \'Contenu\', 5);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(6, \'FaqAdmin\', 1, \'\', 1, 1, \'1\', \'\', \'FAQ\', \'faq\', \'href=\"admin.php?op=FaqAdmin\"\', 1, \'Contenu\', 6);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(7, \'Ephemerids\', 1, \'\', 1, 1, \'1\', \'\', \'Ephémérides\', \'ephem\', \'href=\"admin.php?op=Ephemerids\"\', 1, \'Contenu\', 7);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(8, \'HeadlinesAdmin\', 1, \'\', 1, 1, \'\', \'\', \'News Externes\', \'headlines\', \'href=\"admin.php?op=HeadlinesAdmin\"\', 1, \'Contenu\', 8);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(9, \'DownloadAdmin\', 1, \'\', 1, 1, \'\', \'\', \'Téléchargements\', \'download\', \'href=\"admin.php?op=DownloadAdmin\"\', 1, \'Contenu\', 9);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(10, \'mod_users\', 1, \'\', 1, 1, \'\', \'\', \'Utilisateurs\', \'users\', \'href=\"admin.php?op=mod_users\"\', 2, \'Utilisateurs\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(11, \'groupes\', 1, \'\', 1, 1, \'\', \'\', \'Groupes\', \'groupes\', \'href=\"admin.php?op=groupes\"\', 2, \'Utilisateurs\', 2);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(12, \'mod_authors\', 1, \'\', 1, 1, \'\', \'\', \'Administrateurs\', \'authors\', \'href=\"admin.php?op=mod_authors\"\', 2, \'Utilisateurs\', 3);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(13, \'MaintForumAdmin\', 1, \'\', 1, 1, \'\', \'\', \'Maintenance Forums\', \'forum\', \'href=\"admin.php?op=MaintForumAdmin\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(14, \'ForumConfigAdmin\', 1, \'\', 1, 1, \'\', \'\', \'Configuration Forums\', \'forum\', \'href=\"admin.php?op=ForumConfigAdmin\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(15, \'ForumAdmin\', 1, \'\', 1, 1, \'\', \'\', \'Edition Forums\', \'forum\', \'href=\"admin.php?op=ForumAdmin\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(16, \'lnl\', 1, \'\', 1, 1, \'\', \'\', \'Lettre D\'\'info\', \'lnl\', \'href=\"admin.php?op=lnl\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(17, \'email_user\', 1, \'\', 1, 1, \'\', \'\', \'Message Interne\', \'email_user\', \'href=\"admin.php?op=email_user\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(18, \'BannersAdmin\', 1, \'\', 1, 1, \'\', \'\', \'Bannières\', \'banner\', \'href=\"admin.php?op=BannersAdmin\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(19, \'create\', 1, \'\', 1, 1, \'\', \'\', \'Sondages\', \'newpoll\', \'href=\"admin.php?op=create\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(20, \'reviews\', 1, \'\', 1, 1, \'\', \'\', \'Critiques\', \'reviews\', \'href=\"admin.php?op=reviews\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(21, \'hreferer\', 1, \'\', 1, 1, \'\', \'\', \'Sites Référents\', \'referer\', \'href=\"admin.php?op=hreferer\"\', 3, \'Communication\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(22, \'blocks\', 1, \'\', 1, 1, \'\', \'\', \'Blocs\', \'block\', \'href=\"admin.php?op=blocks\"\', 4, \'Interface\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(23, \'mblock\', 1, \'\', 1, 1, \'\', \'\', \'Bloc Principal\', \'blockmain\', \'href=\"admin.php?op=mblock\"\', 4, \'Interface\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(24, \'ablock\', 1, \'\', 1, 1, \'\', \'\', \'Bloc Administration\', \'blockadm\', \'href=\"admin.php?op=ablock\"\', 4, \'Interface\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(25, \'Configure\', 1, \'\', 1, 1, \'\', \'\', \'Préférences\', \'preferences\', \'href=\"admin.php?op=Configure\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(26, \'ConfigFiles\', 1, \'\', 1, 1, \'\', \'\', \'Fichiers configurations\', \'preferences\', \'href=\"admin.php?op=ConfigFiles\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(27, \'FileManager\', 1, \'\', 1, 1, \'\', \'\', \'Gestionnaire Fichiers\', \'filemanager\', \'href=\"admin.php?op=FileManager\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(28, \'supercache\', 1, \'\', 1, 1, \'\', \'\', \'SuperCache\', \'overload\', \'href=\"admin.php?op=supercache\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(29, \'OptimySQL\', 1, \'\', 1, 1, \'\', \'\', \'OptimySQL\', \'optimysql\', \'href=\"admin.php?op=OptimySQL\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(30, \'SavemySQL\', 1, \'\', 1, 1, \'\', \'\', \'SavemySQL\', \'savemysql\', \'href=\"admin.php?op=SavemySQL\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(31, \'MetaTagAdmin\', 1, \'\', 1, 1, \'\', \'\', \'MétaTAGs\', \'metatags\', \'href=\"admin.php?op=MetaTagAdmin\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(32, \'MetaLangAdmin\', 1, \'\', 1, 1, \'\', \'\', \'META-LANG\', \'metalang\', \'href=\"admin.php?op=Meta-LangAdmin\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(33, \'setban\', 1, \'\', 1, 1, \'\', \'\', \'IP\', \'ipban\', \'href=\"admin.php?op=Extend-Admin-SubModule&amp;ModPath=ipban&amp;ModStart=setban\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(34, \'session_log\', 1, \'\', 1, 1, \'\', \'\', \'Logs\', \'logs\', \'href=\"admin.php?op=Extend-Admin-SubModule&ModPath=session-log&ModStart=session-log\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(36, \'mes_npds_versus\', 1, \'\', 1, 1, \'\', \'Une nouvelle version est disponible ! Cliquez pour acc&#xE9;der &#xE0; la zone de t&#xE9;l&#xE9;chargement de NPDS.\', \'\', \'message_npds\', \'\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(37, \'autoStory\', 1, \'\', 1, 0, \'0\', \'\', \'Auto-Articles\', \'autonews\', \'href=\"admin.php?op=autoStory\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(38, \'submissions\', 1, \'\', 1, 1, \'6\', \'Article en attente de validation !\', \'Articles\', \'submissions\', \'href=\"admin.php?op=submissions\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(39, \'hreferer_al\', 1, \'\', 1, 0, \'!!!\', \'Limite des r&#xE9;f&#xE9;rants atteinte : pensez &#xE0; archiver vos r&#xE9;f&#xE9;rants.\', \'Sites Référents\', \'referer\', \'href=\"admin.php?op=hreferer\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(49, \'npds_twi\', 0, \'\', 1, 1, \'\', \'\', \'Npds_Twitter\', \'npds_twi\', \'href=\"admin.php?op=Extend-Admin-SubModule&ModPath=npds_twi&ModStart=admin/npds_twi_set\"\', 6, \'Modules\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(62, \'mes_npds_3\', 0, \'\', 1, 1, \'\', \' Alerte rouge Ã§a bug ..\', \'\', \'flag_red\', \'\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(59, \'mes_npds_2\', 0, \'\', 1, 1, \'\', \'Ceci est une note d\'\'information provenant de NPDS.\', \'\', \'flag_red\', \'\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(51, \'modules\', 1, \'\', 1, 1, \'\', \'\', \'Gestion modules\', \'modules\', \'href=\"admin.php?op=modules\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(58, \'mes_npds_1\', 0, \'\', 1, 1, \'\', \'Ceci est une alerte de sÃ©curitÃ© provenant de NPDS.\', \'\', \'flag_red\', \'\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(40, \'abla\', 1, \'\', 1, 1, \'\', \'\', \'Blackboard\', \'abla\', \'href=\"abla.php\"\', 5, \'Syst&#xE8;me\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(35, \'reviews\', 1, \'\', 1, 1, \'1\', \'Critique en atttente de validation.\', \'Critiques\', \'reviews\', \'href=\"admin.php?op=reviews\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(41, \'newlink\', 1, \'\', 1, 1, \'1\', \'Lien &#xE0; valider\', \'Lien\', \'links\', \'href=\"admin.php?op=links\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(42, \'brokenlink\', 1, \'\', 1, 0, \'0\', \'Lien rompu &#xE0; valider\', \'Lien rompu\', \'links\', \'href=\"admin.php?op=LinksListBrokenLinks\"\', 9, \'Alerte\', 0);';
$result = @sql_query($sql);
$sql='INSERT INTO fonctions VALUES(43, \'archive-stories\', 1, \'\', 1, 1, \'\', \'\', \'Archives articles\', \'archive-stories\', \'href=\"admin.php?op=Extend-Admin-SubModule&ModPath=archive-stories&ModStart=admin/archive-stories_set\"\', 1, \'Contenu\', 4);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO headlines VALUES (4, \'Global\', \'http://global.npds.org\', \'http://global.npds.org/backend.php\', 0);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO lblocks VALUES (4, \'Chat Box\', \'function#makeChatBox\', \'0\', 2, 10, 1, 0, \'\');';
$result = @sql_query($sql);
$sql='INSERT INTO lblocks VALUES (5, \'Forums Infos\', \'function#RecentForumPosts\\r\\nparams#Forums Infos,15,0,false,10,false,-:\\r\\n\', \'0\', 5, 60, 1, 0, \'\');';
$result = @sql_query($sql);
$sql='INSERT INTO lblocks VALUES (6, \'Les plus t&eacute;l&eacute;charg&eacute;s\', \'function#topdownload\', \'0\', 6, 3600, 1, 0, \'\');';
$result = @sql_query($sql);
$sql='INSERT INTO lblocks VALUES (7, \'Administration\', \'function#adminblock\', \'0\', 3, 0, 1, 0, \'\');';
$result = @sql_query($sql);
$sql='INSERT INTO lblocks VALUES (8, \'Eph&eacute;m&eacute;rides\', \'function#ephemblock\', \'0\', 7, 28800, 1, 0, \'\');';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO modules VALUES (1, \'archive-stories\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO modules VALUES (2, \'wspad\', 1);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (1, 0, \'icon4.gif\', 1, 1, 2, \'Demo\', \'2011-10-26 17:00\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (2, 0, \'icon8.gif\', 1, 1, 2, \'R&eacute;ponse\', \'2012-03-05 22:36\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (3, 0, \'icon1.gif\', 2, 2, 1, \'Message 1\', \'2013-05-14 22:54\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (4, 3, \'icon1.gif\', 2, 2, 1, \'R&eacute;ponse au Message 1\', \'2003-05-14 22:54\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (5, 4, \'icon1.gif\', 2, 2, 1, \'R&eacute;ponse &agrave; la r&eacute;ponse du Message 1\', \'2013-05-14 22:55\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (6, 0, \'icon1.gif\', 2, 2, 1, \'R&eacute;ponse au Message 1\', \'2013-05-14 22:55\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
$sql='INSERT INTO posts VALUES (7, 0, \'         \', 2, -2, 2, \'Bien, bien et m&ecirc;me mieux encore\', \'2012-07-22 13:42:22\', \'1.1.76.115\', \'\', 1);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO rblocks VALUES (2, \'Information\', \'<p align=\"center\"><a href=\"http://www.npds.org\" target=\"_blank\"><img src=\"images/powered/miniban-bleu.png\" border=\"0\" alt=\"npds_logo\" /></a></p>\', \'0\', 0, 0, 1, 0, \'\');';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO reviews_main VALUES (\'Votre point de vue nous int&eacute;resse\', \'Participez &agrave; la vie du site en apportant vos critiques mais restez toujours positif.\');';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO users VALUES (2, \'user\', \'user\', \'user@user.land\', \'\', \'http://www.userland.com\', \'014.gif\', \'989445600\', \'\', \'\', \'\', \'\', \'User of the Land\', 0, 0, \'\', \'\', \'\', \'\', \'d.q1Wcp0KUqsk\', 10, \'\', 0, 0, 0, \'\', 1, \'<ul><li><a href=http://www.npds.org target=_blank>NPDS.ORG</a></li></ul>\', \'Mouse-IT2\', 4096, 4, 0, 1, 1, \'french\', \'1384102103\', 1);';
$result = @sql_query($sql);
...
$result = @sql_query($sql);
$sql='INSERT INTO users_extend VALUES (2, \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'15/07/2005\', \'\', \'none\');';
$result = @sql_query($sql);
