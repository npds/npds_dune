...
function adm_translate($phrase) {
 ...
 switch($phrase) {
  ...
  case "Pour les Bannières Javascript, saisir seulement le code javascript dans la zone Url du Clik et laisser la zone image vide.": $tmp="对于使用Javascript 的Banners，仅在ClickUrl TextBox中书写javascript编码，不用输入图片的URL地址"; break;
  case "Pour les Bannières encore plus complexes (Flash, ...), saisir simplement la référence à votre_répertoire/votre_fichier.txt (fichier de code php) dans la zone Url du Clik et laisser la zone image vide.": $tmp="对于复杂的Banners (比如Flash等)：仅在ClickUrl TextBox中书写参数用于表述您的目录/ .txt 文件位置(php编码文件) "; break;
  case "Nom de l'Annonceur : ": $tmp="客户名: "; break;
  ...
  case "(Ex. : fr(FranÁais), en(Anglais), en-us(Américain), de(Allemand), it(Italien), pt(Portugais), etc)": $tmp = "&#x4F8B;&#x5B50;&#xFF1A; fr(&#x6CD5;&#x8BED;), en(&#x82F1;&#x8BED;), en-us(&#x7F8E;&#x82F1;&#x8BED;), de(&#x5FB7;&#x8BED;), it(&#x610F;&#x5927;&#x5229;&#x8BED;), pt(&#x8461;&#x8404;&#x7259;), &#x7B49;&#x7B49;&#xFF09;"; break;
 ...
 // SABLE
   ...
   /**/case "La désinstallation des modules n'est pas prise en charge de faÁon automatique à l'heure actuelle.": $tmp = "The desinstallation of the addons is not dealt with automatic of way at the present time."; break;
