...
if (!function_exists("Mysql_Connexion")) {
   ...
   <ul class="list-group">
      <li class="list-group-item"><i class="fa fa-users fa-2x text-muted"></i>&nbsp;'.translate("Registered Users: ").' <span class="tag tag-default float-xs-right">'.wrh($unum).' </span></li>
      <li class="list-group-item"><i class="fa fa-user fa-2x text-muted"></i>&nbsp;<i class="fa fa-pencil fa-lg text-muted"></i>&nbsp;'.translate("Active Authors: ").' <span class="label label-default float-xs-right">'.wrh($anum).' </span></li>';
   if ($ibid=theme_image("stats/postnew.png")) {$imgtmp=$ibid;} else { $imgtmp="images/admin/postnew.png";}
   echo '
      <li class="list-group-item"><img src="'.$imgtmp.'" alt="" />&nbsp;'.translate("Stories Published: ").' <span class="tag tag-default float-xs-right">'.wrh($snum).' </span></li>';
   if ($ibid=theme_image("stats/topicsman.png")) {$imgtmp=$ibid;} else { $imgtmp="images/admin/topicsman.png";}
   echo '
      <li class="list-group-item"><img src="'.$imgtmp.'" alt="" />&nbsp;'.translate("Active Topics: ").' <span class="tag tag-default float-xs-right">'.wrh($tnum).' </span></li>
      <li class="list-group-item"><i class="fa fa-comments fa-2x text-muted"></i>&nbsp;'.translate("Comments Posted: ").' <span class="tag tag-default float-xs-right">'.wrh($cnum).' </span></li>';
