...
/************************************************************************/
   ...
   */
   ...
   while (list($topicid, $topics) = sql_fetch_row($toplist)) {
      echo '
         <option '.($topicid == $topic ? 'selected="selected"' : '').' value="'.$topicid.'" >'.substr_replace(aff_langue($topics),'...',25,-1).'</option>';
   }
   echo '
      </select>
   </div>
   ...
   while (list($catid, $title) = sql_fetch_row($catlist)) {
      echo '
         <option '.($catid == $category ? 'selected="selected"' : '').' value="'.$catid.'">'.aff_langue($title).'</option>';
   }
   echo '
      </select>
   </div>';
   ...
   while (list($authors) = sql_fetch_row($thing)) {
      echo '
         <option '.($authors == $author ? 'selected="selected"' : '').' value="'.$authors.'">'.$authors.'</option>';
   }
   echo '
      </select>
   </div>';
