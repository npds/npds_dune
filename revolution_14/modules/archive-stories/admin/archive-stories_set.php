...
function SaveSetArchive_stories($maxcount, $arch, $arch_titre, $ModPath, $ModStart) {
   ...
   $content .= "\$arch = $arch;\n";
   $content .= "// Titre de la liste des news (par exemple : \"<h2>Les Archives</h2>\") / si $arch_titre est vide rien ne sera affichÈ \n";
   ...
   switch ($subop) {
       ...
       SaveSetArchive_stories($maxcount, $arch, $arch_titre, $ModPath, $ModStart);
       default:
