...
$content .= "\n//]]>\n</script>";
   ...
   if (file_exists($chemin)) {
      ...
      $ibid ="<img src=\"modules/$ModPath/mini/".$image."\" border=\"0\" width=\"$width\" alt='$row[3]' />";
   }

   //Affichage de l'image
   $content .="<table cellpadding=\"1\" cellspacing=\"0\" border=\"0\" width=\"100%\">\n";
   $content .="<tr>\n";
   if ($image!="") {
      $content .="<td align=\"center\"><a href=\"javascript:picview('$chemin', '$image', '$comment', '$w_i', '$h_i')\">$ibid</a></td></tr>";
   } else {
      $content .="<td align=\"center\">".gal_trans("vous n'avez accés à aucune galerie")."</td></tr>";
   }

   //Affichage de l'invite de connexion dans le bloc si galerie privée
   if( (!isset($user) and $gal_acces!=0)) { /* 0 pour accès public */
       $content .="<tr><td align=\"center\"><a href=\"user.php\">".gal_trans("Galerie Privée, connectez vous")."</a></td></tr>";
       $content .="</table>\n";
   } else {
       $content .="<tr><td align=\"center\"><a href=\"modules.php?ModPath=$ModPath&ModStart=gal&op=gal&galid=$row[1]\">".$gallery."</a></td></tr>";
       $content .="</table>\n";
   }
?>