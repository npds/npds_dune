...
$mime_renderers[ATT_DSP_PLAINTEXT] = "<div><div align=\"center\" style=\"background-color: #cccccc;\">\$att_name\$visible_wrn</div><pre>\$att_contents</pre></div>";
...
$mime_renderers[ATT_DSP_LINK]      = "<span align=\"center\"><a href=\"\$att_url\" target=\"_blank\"><acronym title=\"".upload_translate("Télécharg.")." \$att_name (\$att_type - \$att_size)\"><span style=\"font-size: .65rem;\">\$att_icon<br /><b>\$att_name</b></span></acronym></a><span style=\"font-size: .65rem;\">\$att_size</span><span style=\"font-size: .65rem;\">\$compteur ".upload_translate("Télécharg.")."</span><span align=\"center\">\$visible_wrn</span>";
$mime_renderers[ATT_DSP_IMG] = "<div align=\"center\"><a href=\"javascript:void(0);\" onclick=\"window.open('\$att_url','fullsizeimg','menubar=no,location=no,directories=no,status=no,copyhistory=no,height=600,width=800,toolbar=no,scrollbars=yes,resizable=yes');\"><img src=\"\$att_url\" alt=\"\$att_name\" border=\"0\" \$img_size /></a>\$visible_wrn</div>";
