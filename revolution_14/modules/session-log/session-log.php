...
//   echo "<br />\n";
   ...
   if ($subop=="session") {
      ...
      <table id="tad_ses" data-toggle="table" data-striped="true" data-show-toggle="true" data-search="true" data-mobile-responsive="true">
         ...
         <tbody>';
//      echo "<td width=\"10%\" style=\"font-size: 10px;\">".SessionLog_translate("Nom")."</td><td width=\"5%\" style=\"font-size: 10px;\">".SessionLog_translate("@ IP")."</td><td width=\"15%\" style=\"font-size: 10px;\">".SessionLog_translate("@ IP résolue")."</td><td style=\"font-size: 10px;\">URI</td><td style=\"font-size: 10px;\">Agent</td></tr>";
   ...
   if ($subop=="info") {
      ...
      echo "<td align=\"center\">".SessionLog_translate("@ IP résolue")."</td>";
