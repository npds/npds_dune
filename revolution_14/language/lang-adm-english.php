...
function adm_translate($phrase) {
 ...
 switch($phrase) {
   ...
   case "Ajouter une nouvelle Banniére": $tmp="Add a New Banner"; break;
   ...
   case "Ajouter une Banniére": $tmp="Add Banner"; break;
   ...
   case "Effacer Banniére": $tmp="Delete Banner"; break;
   case "Etes-vous sûr de vouloir effacer cette Banniére ?": $tmp="Are you sure you want to delete this Banner?"; break;
   case "Edition Banniére": $tmp="Edit Banner"; break;
   case "Ajouter plus d'affichages : ": $tmp="Add More Impressions: "; break;
   case "Réservé : ": $tmp="Purchased: "; break;
   case "Fait : ": $tmp="Made: "; break;
   case "Modifier la Banniére": $tmp="Change Banner"; break;
   ...
   case "Cet Annonceur n'a pas de Banniére active pour le moment.": $tmp="This client doesn't have any banners running now."; break;
   ...
   case "Niveau d'accés": $tmp="Access Level"; break;
   ...
   case "Théme d'affichage par défaut : ": $tmp="Default Theme for your Site:"; break;
   ...
   case "(Bréve description des centres d'intérêt du site. 200 caractéres maxi.)": $tmp="(Light description of the interest center of your website. 200 caracters max.)"; break;
   case "Mot(s) clé(s)": $tmp="Keyword(s)"; break;
   case "(Définissez un ou plusieurs mot(s) clé(s). 1000 caractéres maxi.<br />Remarques : une lettre accentuée équivaut le plus souvent à 8 caractéres. La majorité des moteurs de recherche font la distinction minuscule/majuscule. Séparez vos mots par une virgule)": $tmp="(Give one or several keyword(s). 1000 caracters max.<br />Notes : a accentued letter in general count like 8 caracters. More search engines make the difference between min/upper letter. Separate words with , )"; break;
