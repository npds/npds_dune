<?php
/************************************************************************/
/* Theme for NPDS / Net Portal Dynamic System     0-foundation                    */
/*======================================================================*/
/* This theme use the NPDS theme-dynamic engine (Meta-Lang)             */
/*                                                                      */
/* Theme : Dyna-boost (c) 2015 by jpb for Knacss by Bmag                */
/*                                                                      */
...
/* =====================================================================*/
     echo '<section id="corps" class="row " >';
switch ($pdst) {
case "-1":
     echo '<section id="centralcol" class="large-12 columns ">';   /* la partie centrale */
break;
case "0":
     echo '<aside id="leftcol" class="large-3 columns left">';  /* la colonne de gauche qui aura les BLOCS de gauche */
        leftblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="large-9 columns ">';
break;

case "1":
     echo '<aside id="leftcol" class="large-3 columns">';  /* la colonne de gauche qui aura les BLOCS de gauche */
        leftblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="large-6 columns ">';
break;
case "2":
     echo '<section id="centralcol" class="large-9 columns ">';
break;
case "3":
     echo '<aside id="leftcol" class="large-3 columns">';
        leftblocks();
     echo '</aside>';
     echo '<aside  class="large-3 columns right ">';    /* la colonne de droite qui aura les BLOCS de droites */
        rightblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="large-6 columns  ">';
break;
