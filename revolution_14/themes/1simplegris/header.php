<?php
/************************************************************************/
/* Theme for NPDS / Net Portal Dynamic System        SIMPLEGRIS                   */
/*======================================================================*/
...
switch ($pdst) {
case "-1":
     echo '<section id="centralcol" class="col w100 pas mas content">';   /* la partie centrale */
break;
case "0":
     echo '<aside id="leftcol" class="col w20 aside">';  /* la colonne de gauche qui aura les BLOCS de gauche */
        leftblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="col w80 pas mas content">';
break;
...
case "1":
     echo '<aside id="leftcol" class="col w20 aside">';  /* la colonne de gauche qui aura les BLOCS de gauche */
        leftblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="col  w60 pas mas content">';
break;
case "2":
     echo '<section id="centralcol" class="col w80 pas mas  content">';
break;
case "3":
     echo '<aside id="leftcol" class="col w20 pas mas aside">';
        leftblocks();
     echo '</aside>';
     echo '<aside  class="col w20 pas mas redborder aside">';    /* la colonne de droite qui aura les BLOCS de droites */
        rightblocks();
     echo '</aside>';
     echo '<section id="centralcol" class="col w60 pas mas content">';
break;
