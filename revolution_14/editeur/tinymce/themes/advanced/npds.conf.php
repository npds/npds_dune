...
plugins: [
    ...
    'emoticons template paste textcolor colorpicker textpattern imagetools npds'
],



 toolbar: 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | mybutton npds_img npds_perso npds_mns npds_upl npds_metal npds_plug npds_langue',";
