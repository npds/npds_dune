...
function geninfo($did) {
  ...
  if ($okfile) {
	...
	echo '<p><strong>'.translate("Description").'&nbsp;:</strong>&nbsp;'.aff_langue(stripslashes($ddescription)).'</p>';
	echo '<strong>'.translate("Author").'&nbsp;:</strong>&nbsp;'.$duser.'</p>';
	echo '<strong>'.translate("HomePage").'&nbsp;:</strong>&nbsp;<a href="http://'.$dweb.'" target="_blank">'.$dweb.'</a></p>';
  } else {
...
function tlist() {
  ...
  echo "<p class=\"lead\">".translate("Select Category Folder")."</p>";
  echo '<div class="row">';
...
function act_dl_tableheader($dcategory, $sortby, $fieldname, $englishname) {
  echo "<a href=\"download.php?dcategory=$dcategory&amp;sortby=$fieldname\" title=\"".translate("Ascending")."\"><i class=\"fa fa-arrow-circle-up\"></i></a>&nbsp;";
  echo translate("$englishname");
  echo "&nbsp;<a href=\"download.php?dcategory=$dcategory&amp;sortby=$fieldname&amp;sortorder=DESC\" title=\"".translate("Descending")."\"><i class=\"fa fa-arrow-circle-down\"></i></a>";
}

function inact_dl_tableheader($dcategory, $sortby, $fieldname, $englishname) {	
  echo "<a href=\"download.php?dcategory=$dcategory&amp;sortby=$fieldname\"><i class=\"fa fa-arrow-circle-up\"  title=\"".translate("Ascending")."\"></i></a>&nbsp;";
  echo translate("$englishname");  
  echo "&nbsp;<a href=\"download.php?dcategory=$dcategory&amp;sortby=$fieldname&amp;sortorder=DESC\"><i class=\"fa fa-arrow-circle-down\" title=\"".translate("Descending")."\"></i></a>";
}
  ...
  if ($aff) {
	...
	echo '</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal" title="'.translate("Go Back").'"><i class="fa fa-sign-out"></i></button>
