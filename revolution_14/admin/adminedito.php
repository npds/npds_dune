...
function edito($edito_type, $contents, $Xaff_jours, $Xaff_jour, $Xaff_nuit) {
   ...
   if ($contents=="") {
      ...
      <div class="form-group">
         <div class="col-sm-offset-4 col-sm-8">
            <input class="btn btn-primary col-md-6 col-xs-12" type="submit" name="edito_confirm" value="'.adm_translate("Sauver les modifications").'" />
            <a href="admin.php?op=Edito" class="btn btn-secondary col-md-6 col-xs-12">'.adm_translate("Abandonner").'</a>
         </div>
      </div>
      </fieldset>
      </form>';
