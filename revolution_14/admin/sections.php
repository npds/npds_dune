...
function sectionedit($secid) {
   ...
   $number = sql_num_rows($result2);
   if ($number)
      echo " / <span class=\"text-danger\">$number </span>".adm_translate("publication(s) attachée(s)");
   echo "</td></tr></table>\n";
   ...
   echo "<input class=\"bouton_standard\" type=\"button\" value=\"".adm_translate("Retour en arrière")."\" onclick=\"javascript:history.back()\" />";
   echo "</td></tr></form>
         </table>";
   closetable();
   include("footer.php");
