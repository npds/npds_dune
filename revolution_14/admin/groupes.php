   ...
   <form id="form_ad_mb_gr" class="admform" action="admin.php" method="post">
      <fieldset>
         ...
         <div class="form-group">
            <label class="control-label" for="luname">'.adm_translate("Liste des membres").'</label>
...
function groupe_edit($groupe_id) {
   ...
   if ($groupe_id!="groupe_add")
      ...
      echo '
         <div class="form-group">
            <label class="control-label" for="inp_gr_na">'.adm_translate("Nom").'</label>
         ...
         <div class="form-group">
            <label class="control-label" for="groupe_description">'.adm_translate("Description").'</label>
