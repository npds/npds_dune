   ...
   if ($contents=="") {
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ avant que de commencer la gÈnÈration de la page HTML").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ entre le HEAD et /HEAD lors de la gÈnÈration de la page HTML").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ dans l'Èvement ONLOAD de la balise BODY => JAVASCRIPT").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ ‡ la fin du header du thËme").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ avant le dÈbut du footer du thËme").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier est appelÈ aprËs la fin de la gÈnÈration de la page HTML").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier permet d'envoyer un MI personnalisÈ lorsqu'un nouveau membre s'inscrit").'</td>
            <td>
        ...
        <tr>
            ...
            <td>'.adm_translate("Ce fichier permet l'affichage d'informations complÈmentaires dans la page de login").'</td>
            <td>
...
function copy_sample($fileX) {
   ...
   adminhead ($f_meta_nom, $f_titre, $adminimg);
   echo '<div class="jumbotron">
       <p>'.adm_translate("CrÈer le fichier en utilisant le modËle").' ? <br /><br /><a class="btn btn-primary" href="admin.php?op=ConfigFiles_create&amp;modele='.$fileX.'" role="button">'.adm_translate("Oui").'</a>&nbsp;&nbsp;<a class="btn btn-secondary" href="admin.php?op=ConfigFiles" role="button">'.adm_translate("Non").'</a></p>
   </div>';
   adminfoot('','','','');
}
