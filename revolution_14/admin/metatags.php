...
function MetaTagAdmin($saved = false) {
   ...
   if ($saved){
      echo '<p align="center " class="text-danger">'.adm_translate("Vos MétaTags ont été modifiés avec succés !").'</p>';
   }
   echo '
   ...
   <div class="form-group">
      ...
      <span class="help-block">'.adm_translate("(Bréve description des centres d'intérêt du site. 200 caractéres maxi.)").'</span>
   </div>
   <div class="form-group">
      ...
      <span class="help-block">'.adm_translate("(Définissez un ou plusieurs mot(s) clé(s). 1000 caractéres maxi.<br />Remarques : une lettre accentuée équivaut le plus souvent à 8 caractéres. La majorité des moteurs de recherche font la distinction minuscule/majuscule. Séparez vos mots par une virgule)").'</span>
   </div>
   <div class="form-group">
